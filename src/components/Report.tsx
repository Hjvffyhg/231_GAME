    ...
    <div className="absolute inset-0 w-full h-full bg-[#0A0F1F] overflow-hidden flex flex-col font-sans text-slate-200 p-4 md:p-8">
      ...
      <div className="relative z-10 flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-3">
          {exportMessage && (
            <span className="text-xs font-mono text-[#00D9FF] animate-pulse uppercase tracking-widest mr-2">{exportMessage}</span>
          )}
          <button 
      ...
      <div className="relative z-10 flex flex-col md:flex-row h-full w-full bg-[#0A0F1F]/80 border border-[#00D9FF]/40/50 backdrop-blur-md shadow-[0_0_30px_rgba(6,182,212,0.1)]" style={{ clipPath: 'polygon(0 0, 98% 0, 100% 2%, 100% 100%, 2% 100%, 0 98%)' }}>
           ...
           <nav className="flex flex-row md:flex-col gap-2 md:gap-1.5 w-max md:w-auto">
              {TABS.map((tab) => {
                ...
                return (
                  ...
                  >
                    {isActive && <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#00D9FF] shadow-[0_0_10px_#00D9FF]"></div>}
                    <Icon size={16} className={cn("transition-colors shrink-0", isActive ? "text-[#00D9FF]" : "text-slate-500 group-hover:text-[#00D9FF]/50")} />
...
function TechCard({ children, title, icon: Icon, color = 'cyan', className = '' }: any) {
    const colors = {
        ...
        emerald: 'border-emerald-500/30 bg-[#0d1428]/60 text-emerald-400 shadow-emerald-500/10',
        indigo: 'border-[#6366F1]/30 bg-[#0d1428]/60 text-[#6366F1] shadow-[#6366F1]/10',
        amber: 'border-amber-500/30 bg-[#0d1428]/60 text-amber-400 shadow-amber-500/10',
    ...
    <div className="space-y-8">
      ...
      <TechCard color="cyan">
          ...
          <div className="space-y-4 grid grid-cols-1">
            <div className="bg-[#0A0F1F]/80 border border-[#151f3d] p-4 flex gap-4 items-start" style={{ clipPath: 'polygon(0 0, 100% 0, 98% 100%, 0 100%)' }}>
              <div className="bg-[#EF4444]/20 text-[#EF4444] p-2 shrink-0 border border-[#EF4444]/30"><Eye size={16} /></div>
              <div><strong className="text-[#EF4444] font-mono tracking-widest uppercase block mb-1">Phase 1: Fixation</strong> The swarm behaves predictably, hyper-focusing on the oldest perceived threat before moving to the next.</div>
            </div>
            <div className="bg-[#0A0F1F]/80 border border-[#151f3d] p-4 flex gap-4 items-start" style={{ clipPath: 'polygon(0 0, 100% 0, 98% 100%, 0 100%)' }}>
            ...
            <div className="bg-[#0A0F1F]/80 border border-[#151f3d] p-4 flex gap-4 items-start" style={{ clipPath: 'polygon(0 0, 100% 0, 98% 100%, 0 100%)' }}>
               <div className="bg-[#6366F1]/20 text-[#6366F1] p-2 shrink-0 border border-[#6366F1]/30"><BrainCircuit size={16} /></div>
              <div><strong className="text-[#6366F1] font-mono tracking-widest uppercase block mb-1">Phase 3: Vindictive Learning</strong> The most dangerous state. The swarm recognizes which presences have been ignored and violently prioritizes them. The longer it watches you, the more vicious the execution.</div>
            </div>
          </div>
      </TechCard>
    </div>
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2 border-l-4 border-[#00D9FF] pl-4">
        ...
        <p className="text-sm font-mono text-[#00D9FF]/80 tracking-widest uppercase">Deep dive into alien cognition.</p>
      </div>
        ...
        <TechCard title="Reaction to Threat Presence" color="cyan">
           <div className="space-y-4 font-mono text-sm">
             <div className="flex gap-4 border-b border-[#00D9FF]/40/30 pb-4">
               <span className="text-[#EF4444] font-bold w-24 shrink-0">FIXATED</span>
             ...
             <div className="flex gap-4">
               <span className="text-[#6366F1] font-bold w-24 shrink-0">VINDICTIVE</span>
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2 border-l-4 border-[#00D9FF] pl-4">
        ...
        <p className="text-sm font-mono text-[#00D9FF]/80 tracking-widest uppercase">Projected dangers of swarm states.</p>
      </div>

      <TechCard color="cyan">
          <div className="bg-[#0d1428]/60 border border-[#1e2b52] overflow-hidden" style={{ clipPath: 'polygon(0 0, 100% 0, 100% 95%, 98% 100%, 0 100%)' }}>
